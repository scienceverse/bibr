...
Footnotes are kept in the text table, so their xref_id is the text_id of that footnote. 
...
Each table is given a unique section_id in the sections table and a unique tbl_id to reference it in the xrefs table. The title is in sections:header and the caption is in text.
...
Each figure is given a unique section_id in the sections table and a unique fig_id to reference it in the xrefs table. The title is in sections:header and the caption is in text.
